...
module.exports = {
  ...
  definitionFilter(defFields) {
    ...
    const computedKeys = Object.keys(computed); // 计算 computed
    ...
    const initComputed = () => {
      defFields.data = defFields.data || {}; // 先将 properties 里的字段写入到 data 中
      ...
      if (properties) {
        ...
        Object.keys(properties).forEach(key => {
          ...
          let oldObserver; // eslint-disable-next-line max-len
          ...
          properties[key].observer = function (...args) {
            ...
            this._doingSetData = true; // 计算 computed

            const needUpdate = calcComputed(this); // 做 computed 属性的 setData
    ...
    defFields.methods._setData = function (data, callback) {
      ...
      this._doingSetData = true; // TODO 过滤掉 data 中的 computed 字段
      ...
      originalSetData.call(this, data, callback); // 计算 computed
