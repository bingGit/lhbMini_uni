	...
	<view>
		...
		<view class="ablum-content-container">
			...
			<view class="ablum-c-slider">
				...
				<slider min="0" :max="max" backgroundColor="#dddee1" activeColor="#298CEF" step="2" block-size="16" @change="bindChangeTap"
				 @changing="changeingTap" :value="seeker" class="ablum-slider"></slider>
		...
		<modals-bottom id="modalsComment" ref="modalsComment" radius="radius" :height="windowH">
			<view slot="body">
				<view class="modals-bottom-comment-container">
					...
					<!-- 正文内容 -->
					<scroll-view @scrolltoupper="hideModalFun" scroll-y :style="'height:' + windowH + 'px;'" @touchstart="touchmoveStart"
				...
				<view class="modals-bottom-write-container">
					<form @submit="formSubmit">
						...
						<view class="modals-bottom-write-content">
							<textarea name="comment" :value="textareaValue" placeholder-class="write-content-style" class="write-content-style"
							 placeholder="在此写评论..." :maxlength="maxlength" :auto-focus="autoFocus" @confirm adjust-position="false" @input="bindWordLimit"
							 fixed="true">
          </textarea>
						</view>
					</form>
		...
		<!-- 客服弹框 -->
		<custom-modal id="customModal" ref="customModal" :cfg="custom_cfg" confirmText="解锁" modalSize="md" title="提示"
		 @cancelEvent="_cancelEvent" @confirmEvent="_confirmEventThird" @invitShareEvent="_invitShareEvent">
