...
var CryptoJS = __webpack_require__(/*! ./cryptojs.js */ 13);
...
var oauthType = 25; //copy 需修改改

var userListenRecord = 'user_listen_record';
...
function postRequest(netUrl, data, _success) {
...
function backLog(content) {
  ...
  var userMsg = wx.getStorageSync(userKey);
  wx.request({
...
function getCommentId(id) {
  var openidMsg = wx.getStorageSync(userKey); // return 'lhbjdc_' + openidMsg['openId'] + '_' + id;
      ...
      if (res.code) {
        ...
        wx.request({
          ...
          success: function success(res) {
            ...
            if (msg.e == '9999') {
              var openId = msg.data.openid; //获取到的openid

              var sessionId = msg.data.session_key; //获取到session_key
...
function getLockData(that) {
  var userToken = wx.getStorageSync(userKey);
...
function updateHot(uid, id, childId) {var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  //发起网络请求
  wx.request({
...
function formLoadMTime(time) {
  ...
  m = m < 10 ? '0' + m : m;
  var i_t = parseInt(time % 60000);
  var i = (Array(2).join(0) + i_t).slice(1, 3); // let i = Math.floor(i_t * 100) / 100;
...
function secret(string) {var ivs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';var operation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
function debounce(fn, delay) {
  ...
  return function () {
    ...
    // 获得函数的作用域和参数
    var context = this;
    var args = arguments; // 如果事件被触发，清除 timer 并重新开始计时
...
var util = __webpack_require__(/*! ./util.js */ 12);
...
/***/ 7:
/*!**********************************************************************!*\
  !*** /Users/bing/lhbWordMiniProgram_uni/pages.json?{"type":"style"} ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/ablum/ablum": {}, "pages/login/changePhone": {}, "pages/coupon/coupon": {}, "pages/order/order": {}, "pages/navbar/navbar": {}, "pages/wtest/result": { "backgroundTextStyle": "light", "navigationBarTitleText": "测试结果" }, "pages/pay/pay": {}, "pages/deal/deal": { "navigationBarTitleText": "支付结果" }, "pages/wtest/wtest": { "backgroundTextStyle": "light", "navigationBarTitleText": "测试" }, "pages/wtest/rank": {}, "pages/login/login": { "navigationBarTitleText": "快速登录" }, "pages/login/bindingPhone": {}, "pages/webview/award": {}, "pages/my/my": {}, "pages/wtest/result_list": { "navigationBarTitleText": "答案" }, "pages/ablum/ablum-content": { "disableScroll": true }, "pages/ablum/ablum-detail": { "disableScroll": true } }, "globalStyle": { "backgroundTextStyle": "light", "navigationBarBackgroundColor": "#3075C6", "navigationBarTitleText": "刘洪波讲单词", "navigationBarTextStyle": "white", "backgroundColor": "#ccc", "navigationStyle": "custom" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!*********************************************************************!*\
  !*** /Users/bing/lhbWordMiniProgram_uni/pages.json?{"type":"stat"} ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
